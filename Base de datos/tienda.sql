...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-11-2021 a las 04:01:53
...
INSERT INTO `tblproductos` (`ID`, `Nombre`, `Descripcion`, `Precio`, `Cantidad`, `Imagen`) VALUES
(1, 'Minecraft', 'Explora mundos generados al azar y construye cosas increíbles, desde la más humilde de las casas hasta el más majestuoso de los castillos. Juega en el modo creativo con recursos ilimitados o extrae en las profundidades del mundo, crea armas y armaduras para defenderte de enemigos peligrosos en el modo supervivencia.', '349.00', 1, '../img/1.jpg'),
(2, 'Resident Evil 2', 'Publicado originalmente en 1998, Resident Evil 2, uno de los juegos más icónicos de todos los tiempos, regresa completamente reinventado para las consolas de nueva generación.', '448.20', 1, '../img/2.jpg'),
(3, 'Destiny', 'De los creadores de Halo® y los editores de Call of Duty®. Destiny es un shooter en primera persona con una rica historia de corte cinematográfico ambientada en enormes mundos que podrás explorar. Crea y personaliza tu guardián. Derrota a tus enemigos. Conviértete en leyenda en intensos modos de juego cooperativos, competitivos y públicos.', '200.00', 1, '../img/3.jpg'),
(4, 'Bloodborne', 'Con este juego de Bloodborne vas a disfrutar de horas de diversión y de nuevos desafíos que te permitirán mejorar como gamer.\r\nInteractúa con otros jugadores\r\nPodrás disfrutar de una experiencia inigualable, ya que te permite jugar con tus amistades y compartir momentos inolvidables.\r\nDiversión sin fronteras\r\nPodrás compartir cada juego con personas de todo el mundo, ya que es posible conectarse de manera online.', '580.00', 1, '../img/4.jpg'),
(5, 'Forza motorsport 6', 'Forza Motorsport 6 es la acción incesante a velocidad de simulación en el juego de carreras más hermoso y completo de esta generación. Colecciona, personaliza y pilota más de 450 coches Forzavista™ con cabinas funcionales y daños realistas. Compite en carreras épicas para 24 jugadores en 26 emplazamientos de fama mundial. Domina el clima lluvioso y las carreras nocturnas en tu camino a la victoria.', '800.00', 1, '../img/5.jpg'),
(6, 'Gran Turismo 6', 'Con este juego de Gran Turismo vas a disfrutar de horas de diversión y de nuevos desafíos que te permitirán mejorar como gamer.\r\nInteractúa con otros jugadores\r\nPodrás disfrutar de una experiencia inigualable, ya que te permite jugar con tus amistades y compartir momentos inolvidables.\r\nDiversión sin fronteras\r\nPodrás compartir cada juego con personas de todo el mundo, ya que es posible conectarse de manera online.', '600.00', 1, '../img/6.jpg'),
